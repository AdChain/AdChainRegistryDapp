          ...
          <Tab.Pane className='RedditTab' attached={false}>
            <div className='RedditActionButtons'>
              ...
              <div className='RedditButtonsContainer'>
                <Button basic className='ViewButton'>View</Button>
            ...
            <div className='RedditPostsContainer'>
              <div className='RedditPosts'>
                ...
                <div className='PostContent'>
                  This publisher is legit. They are so legit. Super legit. Vote these guys in.
                </div>
              </div>
              <div className='RedditPosts'>
                <div className='PostInfo'>
                ...
                <div className='PostContent'>
                  I agree. This publisher has proven to be high quality.
                </div>
              </div>
            </div>
            <div className='RedditInputContainer'>
              <Input placeholder='Message (press enter to submit)' />
            </div>
          </Tab.Pane>
      },
      {
          ...
          <Tab.Pane className='RedditTab' attached={false}>
            ...
            <div className='RedditPostsContainer'>
              <div className='RedditPosts'>
                ...
                <div className='PostContent'>
                  This publisher is NOT legit. They are so NOT legit. Super NOT legit. Vote these guys out.
                </div>
              </div>
              <div className='RedditPosts'>
                <div className='PostInfo'>
                ...
                <div className='PostContent'>
                  I agree. This publisher has proven to be bad quality.
                </div>
              </div>
            </div>
          </Tab.Pane>
